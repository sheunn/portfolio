...
experiences = {
    ...
    "ces-2026": {
        ...
        "category": "해외연수",
        "summary": "경기대학교 SW중심대학사업단 주관 SW상상기업 프로그램의 우수 참여자로 선발되어 미국 실리콘밸리 연수에 참가했습니다. CES 2026을 참관하며 글로벌 AI·SW 기술 트렌드를 직접 탐색하고, Google·NVIDIA 등 빅테크 기업을 탐방했습니다.",
        "highlights": [
            "CES 2026 참관 — 글로벌 AI·SW 트렌드 탐색",
            "Google, NVIDIA 등 빅테크 기업 탐방",
            "UC 버클리·스탠퍼드 특강 참여",
        ],
    },
}
