...
projects = {
    ...
    "trenddo": {
        "title": "TrendDo",
        "subtitle": "세대·지역 문화를 번역하는 문화 순환 플랫폼",
        "award": "AI·SW 해커톤 Khuthon 2026 우수상",
        "overview": "숏폼과 알고리즘 속에서 빠르게 소비되고 사라지는 대중문화 유행을, 세대별 언어와 지역 맥락, 전통문화 요소로 번역하고 실제 참여 가능한 행동으로 전환하는 문화 순환 플랫폼입니다.",
        "features": [],
        "role_title": "",
        "role_detail": "",
        "tech": [],
    ...
    "daejeon-subway-congestion": {
        "title": "시공간 그래프 신경망 기반 대전 지하철 혼잡도 예측",
        "subtitle": "빅데이터 분석 경진대회",
        "award": None,
        "overview": "수도권 지하철 혼잡 사고가 도시 안전 문제로 확산되는 상황을 배경으로, 대전 도시철도 1호선의 혼잡도를 사전 예측하고 정책에 활용하기 위한 시공간 딥러닝 모델을 제안한 프로젝트입니다. 대전교통공사 승하차 데이터에 기상·POI·달력 정보를 결합해 약 128,000개의 시간·역별 혼잡도 포인트를 생성하고, DCRNN 기반 예측 모델을 설계·구현했습니다.",
        "features": [
            "Stock-Flow 모델로 플랫폼 내 실제 잔류 인원 기반 혼잡도 산출",
            "출퇴근 이중봉형 혼잡 패턴 등 시공간 패턴 시각화 및 인사이트 도출",
            "22개 역·192개 엣지 방향성 그래프 구조화 후 DCRNN+Attention 모델 학습",
        ],
        "role_title": "정책 제안 구체화",
        "role_detail": "분석 결과를 바탕으로 3가지 정책 시뮬레이션 시나리오를 설계했습니다: 역 폐쇄 시 인접 역 혼잡 전파 분석 및 분산 안내 전략, 공휴일·날씨·계절 요인 기반 사전 배차 조정 시뮬레이션, POI/상권 변화에 따른 혼잡도 변동 예측을 통한 도시계획 정책 평가 기반 마련.",
        "tech": ["Python", "DCRNN", "GNN", "Stock-Flow 모델", "시계열 분석", "POI 데이터", "데이터 시각화"],
    },
    "trusteye": {
        "title": "TrustEYE",
